...
# please add your data folder in setwd("")
...
mapping_text(mos_pars=updated_pars, panel=1, frag=1,
            x=data_marker$Start+data_marker$End, y=1, y.range=c(0,1), texts=data_marker$Description, angle="auto")
dev.off()
